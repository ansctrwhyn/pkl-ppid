  ...
  <div class="content-wrapper">
  	...
  	<div class=" container-fluid" style="padding-top: 65px">
  		...
  		<ol class="breadcrumb shadow" style="background-color:#fff;">
  			...
  			<li class="breadcrumb-item">
  				<a href="<?= base_url("admin/") ?>informasi_setiap_saat">Informasi Setiap Saat</a>
  			</li>
  			<li class="breadcrumb-item active">Edit Informasi Setiap Saat</li>
  		</ol>

  		<!-- DataTables Example -->
  		<div class="col-md-10" style="display: block; margin-left:auto; margin-right:auto;margin-top:20px; padding-bottom:7px">
  			<div class="card mb-3 shadow">
  				<!-- <div class="card-header" style="background-color:#F9EBEA;"><i class="fas fa-table"></i> Form Edit Informasi Setiap Saat</div> -->
  				<div class="card-header" style="background-color:#F9EBEA; letter-spacing:1px;">
  					<h5> <i class="fab fa-wpforms"></i> Form Edit Informasi Setiap Saat</h5>
  				</div>
  				<div class="card-body">
  					<?= $this->session->flashdata('message'); ?>
  					<div class="container">
  						<form action="<?= base_url('admin/editInformasiSetiapSaat/'); ?><?= $informasi_setiap_saat['id_informasi'] ?>" method="POST" enctype="multipart/form-data">
  							<div class="form-group row">
  								<label for="judul" class="col-sm-2 col-form-label">Judul</label>
  								<div class="col-sm-10">
  									<input type="text" class="form-control" id="judul" name="judul" value="<?= $informasi_setiap_saat['judul']; ?>">
  							...
  							<div class="form-group row justify-content-end">
  								<div class="col-sm-10">
  									...
  									<a href="<?= base_url('admin/informasi_setiap_saat'); ?>">
