  ...
  <div class="content-wrapper">
  	...
  	<div class=" container-fluid" style="padding-top: 65px">
  		...
  		<ol class="breadcrumb shadow" style="background-color:#fff;">
  			...
  			<li class="breadcrumb-item active">Tambah Informasi Setiap Saat</li>
  		</ol>

  		<!-- DataTables Example -->
  		<div class="col-md-10" style="display: block; margin-left:auto; margin-right:auto;margin-top:20px; padding-bottom:7px">
  			<div class="card mb-3 shadow">
  				<!-- <div class="card-header" style="background-color:#F9EBEA;"><i class="fas fa-table"></i> Form Tambah Informasi Setiap Saat</div> -->
  				<div class="card-header" style="background-color:#F9EBEA; letter-spacing:1px;">
  					<h5> <i class="fab fa-wpforms"></i> Form Tambah Informasi Setiap Saat</h5>
  				</div>
  				<div class="card-body">
  					<?= $this->session->flashdata('message'); ?>
  					<div class="container">
  						<?= form_open_multipart('admin/addInformasiSetiapSaat'); ?>
