		...
		<div class="col-md-8" style="display:block;margin-left:auto;margin-right:auto;">
			<div class="card ml-4 mr-4">
				<div class="tab-pane active" id="individu">
					<!-- <form id="form-register" method="POST" action="<?= base_url('auth/daftar_individu'); ?>"> -->
					<?= form_open_multipart('auth/daftar_individu'); ?>
					<div class="card card-md" style="background-color:#F9EBEA">
						<h5 class="text-capitalize text-center head-title">Pendaftaran</h5>
						...
						<div class="col-md-12">
							...
							<div class="mb-3">
								...
								<div class="form-group">
									<label for="">Nomor Identitas (KTP/SIM/Passport/Lainnya)</label>
								...
								<div class="form-group">
									<label for="">Scan Kartu Identitas</label>
									<div class="col-sm-10">
								...
								<div class="form-group">
									...
									<textarea id="alamat" maxlength="255" name="alamat" rows="3" class="form-control"><?= set_value('alamat'); ?></textarea>
